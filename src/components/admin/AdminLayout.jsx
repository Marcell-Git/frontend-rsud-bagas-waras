...
const TopBar = ({ sidebarCollapsed, setMobileMenuOpen }) => {
  return (
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="hidden md:flex items-center gap-2 text-slate-400">
          ...
          <input
            ...
            className="bg-transparent border-none focus:ring-0 text-sm text-slate-600 placeholder:text-slate-400 w-64"
          />
        </div>
      </div>
