...
const TugasRSUD = () => {
  ...
  const handleDelete = (id) => {
    if (window.confirm("Hapus poin tugas ini?")) {
      setTugasPoints(tugasPoints.filter((t) => t.id !== id));
    }
  };
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 pb-12">
      ...
      {/* Content Section (Mirip dengan Visi, tanpa hover pada aksi) */}
